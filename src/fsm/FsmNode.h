...
public:
    ...
    /**
     * Calculates each output that can be generated by fully applying a given input trace and the corresponding target nodes.
    ...
    /**
     * Calculates each output that can be generated by fully applying a given input trace.
     * @param input The given input trace.
     * @param producedOutputs The calculated outputs that can be produced by the given input trace.
     */
	...
	*/
    ...
    /**
     * Returns true if the given trace is contained in the language of this node.
     * Assumes that this node and all nodes reachable from it are obsevable.
     */
    bool exhibitsBehaviour(const IOTrace& trace) const;
    bool exhibitsBehaviour(std::deque<int>& inputs, std::deque<int>& outputs) const;
