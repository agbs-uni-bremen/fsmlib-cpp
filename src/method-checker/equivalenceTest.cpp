...
int main(int argc, char* argv[])
{
    ...
    runTestClass(dfsm, 1, 0, "Class 1",tMethodIOTraces,wMethodIOTraces,wpMethodIOTraces,hMethodIOTraces);
    runTestClass(dfsm, 0, 1, "Class 2",tMethodIOTraces,wMethodIOTraces,wpMethodIOTraces,hMethodIOTraces);
    runTestClass(dfsm, 2, 0, "Class 3",tMethodIOTraces,wMethodIOTraces,wpMethodIOTraces,hMethodIOTraces);
    runTestClass(dfsm, 0, 2, "Class 4",tMethodIOTraces,wMethodIOTraces,wpMethodIOTraces,hMethodIOTraces);
    runTestClass(dfsm, 1, 1, "Class 5",tMethodIOTraces,wMethodIOTraces,wpMethodIOTraces,hMethodIOTraces);
    runTestClass(dfsm, 2, 1, "Class 6",tMethodIOTraces,wMethodIOTraces,wpMethodIOTraces,hMethodIOTraces);
    runTestClass(dfsm, 1, 2, "Class 7",tMethodIOTraces,wMethodIOTraces,wpMethodIOTraces,hMethodIOTraces);
    runTestClass(dfsm, 2, 2, "Class 8",tMethodIOTraces,wMethodIOTraces,wpMethodIOTraces,hMethodIOTraces);
    runTestClass(dfsm, 3, 2, "Class 9",tMethodIOTraces,wMethodIOTraces,wpMethodIOTraces,hMethodIOTraces);
    runTestClass(dfsm, 2, 3, "Class 10",tMethodIOTraces,wMethodIOTraces,wpMethodIOTraces,hMethodIOTraces);
}
