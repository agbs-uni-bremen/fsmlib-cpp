...
int main(int argc, char** argv)
{
	...
	results.push_back(minimise_Fsm_TS());

	// Intersection Test:
	results.push_back(intersect_TS());

	// Calculation of Distinguishing Traces Test:
	results.push_back(getCharacterisationSet_Dfsm_TS());
	results.push_back(getCharacterisationSet_Fsm_TS());
	results.push_back(calcDistinguishingTrace_PkTables_TS());
	results.push_back(calcDistinguishingTrace_OFSMTables_TS());
	results.push_back(calcStateIdentificationSets_TS());
	results.push_back(calcStateIdentificationSetsFast_TS());

	// Complete Test Theories Test:
	results.push_back(tMethod_TS());
	results.push_back(wMethod_Fsm_TS());
	results.push_back(wMethod_Dfsm_TS());
	results.push_back(wMethodOnMinimisedFsm_TS());
	results.push_back(wMethodOnMinimisedDfsm_TS());
	results.push_back(wpMethod_Fsm_TS());
	results.push_back(wpMethod_Dfsm_TS());
	results.push_back(wpMethodOnMinimisedDfsm_TS());
	results.push_back(hsiMethod_Fsm_TS());
	results.push_back(hsiMethod_Dfsm_TS());
	results.push_back(hMethodOnMinimisedDfsm_TS());
